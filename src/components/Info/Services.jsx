...
const services = [
  {
    ...
    description:
      "We define your voice, visuals, and vision to help your brand connect and thrive.",
    subservices: "Visual Identity, Logo Design, Packaging, Guidelines",
  ...
  },
  {
    ...
    description:
      "Human-centered design that turns complex ideas into elegant user experiences.",
    subservices: "Visual Identity, Logo Design, Packaging, Guidelines",
    projects: ["Lummi", "Sonoma", "LINX", "+ 11"],
    projectCount: 12,
    hasImage: true,
...
function ServiceItem({ service, isOpen, onToggle }) {
  return (
    ...
    >
      ...
      <button
        onClick={onToggle}
        className={`py-8 md:py-12 px-4 sm:px-6 md:px-8 text-left transition-all duration-500 border-grey border-t w-full max-w-[1100px]
        }`}
      >
        <AnimatePresence mode="wait">
          {!isOpen ? (
            ...
            <motion.div
              ...
              exit={{ opacity: 0 }}
              className={`grid grid-cols-1 md:grid-cols-[2fr_1.5fr_auto_auto] items-center gap-y-6 md:gap-y-0 gap-x-6 md:gap-x-12 ${
    ...
    <div className="min-h-screen bg-white py-8">
      <div className="max-w-9/10 mx-auto px-4 sm:px-6 md:px-8">
        <div className="mb-8 md:mb-12">
          <h2 className="text-3xl md:text-6xl lg:text-8xl text-center font-bold">
            Services
          </h2>
        </div>
